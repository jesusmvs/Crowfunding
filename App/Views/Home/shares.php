...
<html>
  ...
  <div class="container">
	...
	<?php foreach ($shares as $share): ?>
		<?php if(isset($share['User']['shares'])): ?>
			<h3>User: <?= $share['User']['first_name'].$share['User']['last_name']?></h3>
			<h3>Email: <?= $share['User']['email']?></h3>

			<table class="table table-striped">
				<tr>

					<th>Accredited Shares</th>
					<th>Bounty</th>
					<th>Pay Date</th>
				</tr>
				<?php foreach ($share['User']['shares'] as $val): ?>
					<tr>
